  ...
  return (
    <div className="py-5 px-5 md:px-12 lg:px-28">
      <div className="flex justify-between items-center">
        ...
        />
        <button className="flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-solid border-black shadow-[-7px_7px_0px_#00000]">
          Get Started
      ...
      <div className="text-center my-8">
        ...
        <p className="mt-10 max-w-[740px] m-auto text-xs sm:text-base">
          ...
          neque dolor, officiis laboriosam doloribus sit. Ipsam, omnis rem?
        </p>
        <form
          action=""
